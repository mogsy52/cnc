...
// @version        0.1.3 Beta
// @grant          none
// @downloadURL    http://trinitroglycerol.ddns.net/scripte/ToolBox_Addon_Sektorsprung.user.js
// ==/UserScript==
			...
			qx.Class.define("ToolBox_Addon_Sektorsprung",
				...
				construct: function()
				{
					try
					{
						...
						var SektorsprungButton = new qx.ui.form.Button("Sector Jump").set({
						...
						var SektorsprungFenster = new qx.ui.window.Window("Sector Jump").set({
							showMaximize:false,
							showMinimize:false,
							showClose:true,
							allowClose:true,
						...
						var anzahl = 0;
						var text = "";
						var starten = new qx.ui.form.Button("Start Search").set({
							toolTipText: "Начать поиск",
							width: 100,
							height: 25,
							maxWidth: 100,
							maxHeight: 25,
						...
						var refresh = new qx.ui.form.Button("Refresh Ranking").set({
						...
						var Allichat = new qx.ui.form.RadioButton("Alliance Chat").set({
							width: 100,
							minWidth: 100,
							maxWidth: 100,
							marginLeft: 5
						...
						var SpielerLable = new qx.ui.basic.Label("found player: ").set({
							margin : 5,
							width: 115,
							minWidth: 115,
							maxWidth: 115,
						...
						var berechnen = new qx.ui.form.Button("Calculate landing points").set({
						...
						var Offichat = new qx.ui.form.RadioButton("Officer Chat").set({
							width: 100,
							minWidth: 100,
							maxWidth: 100,
							marginLeft: 10
						...
						buttons[0].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[0].getLabel() + ": [coords]" + textfields[0].getValue() + "[/coords]");
						}, this);
						buttons[1].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[1].getLabel() + ": [coords]" + textfields[1].getValue() + "[/coords]");
						}, this);
						buttons[2].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[2].getLabel() + ": [coords]" + textfields[2].getValue() + "[/coords]");
						}, this);
						buttons[3].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[3].getLabel() + ": [coords]" + textfields[3].getValue() + "[/coords]");
						}, this);
						buttons[4].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[4].getLabel() + ": [coords]" + textfields[4].getValue() + "[/coords]");
						}, this);
						buttons[5].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[5].getLabel() + ": [coords]" + textfields[5].getValue() + "[/coords]");
						}, this);
						buttons[6].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[6].getLabel() + ": [coords]" + textfields[6].getValue() + "[/coords]");
						}, this);
						buttons[7].addListener("click", function () {
							chat.AddMsg(chatkanal + "Expected Landing Point [player]" + Spieler.getValue() + "[/player] at " + buttons[7].getLabel() + ": [coords]" + textfields[7].getValue() + "[/coords]");
						}, this);
						buttons[8].addListener("click", function () {
							chat.AddMsg(chatkanal + "Centre: [coords]" + textfields[8].getValue() + ":" + textfields[9].getValue() + "[/coords]");
						}, this);
